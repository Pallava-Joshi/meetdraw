...
import { Code, Feather, MessageSquare, Share2, Users, Mail, } from "lucide-react";
...
export default function Page() {
    return (<div className="w-full min-h-screen h-fit overflow-x-clip bg-neutral-950 text-white [&::-webkit-scrollbar]:hidden font-nunito-variable">
      <section id="hero" className="relative w-full h-screen flex flex-col justify-center items-center text-center px-4">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="mt-8 flex flex-col items-center sm:flex-row gap-4">
            <Link href="/demo">
              <Button size="lg" className="w-full sm:w-auto cursor-pointer bg-neutral-400/20 backdrop-blur-[1px] border text-neutral-300 border-neutral-300/20 hover:bg-neutral-400/30 hover:border-neutral-300/30">
                Try the Demo <RxArrowTopRight />
              </Button>
            </Link>
            <Link href="/signup">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto cursor-pointer py-[20px] bg-black/20 backdrop-blur-[1.5px] border text-neutral-300 border-neutral-300/20 hover:bg-black/30 hover:border-neutral-300/30">
                Create an account
              </Button>
            </Link>
          </div>
      ...
      <section id="features" className="py-16 md:py-24 px-4">
        ...
        ].map((feature, i) => (<div key={i} className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-lg">
      ...
      <section id="how-it-works" className="py-16 md:py-24 px-4 overflow-clip relative">
        ...
        <div className="container mx-auto text-center">
          <div className="flex justify-around items-center mb-[200px] md:mb-[300px]">
            <div className="hover:scale-110 transition-all duration-300">
              <a href="https://x.com/I_Break_Prod" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors cursor-pointer">
                <BsTwitterX className="w-6 h-6 md:w-7 md:h-7"/>
              </a>
            </div>
            <div className="hover:scale-110 transition-all duration-300">
              <a href="https://www.linkedin.com/in/harshit-breaks-prod/" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors cursor-pointer">
                <FiLinkedin className="w-6 h-6 md:w-7 md:h-7"/>
              </a>
            </div>
            <div className="hover:scale-110 transition-all duration-300">
              <a href="mailto:Pallava Joshi <joshipallava@gmail.com>" className="text-neutral-400 hover:text-white transition-colors cursor-pointer">
                <Mail className="w-6 h-6 md:w-7 md:h-7"/>
              </a>
            </div>
            <div className="hover:scale-110 transition-all duration-300">
              <a href="https://github.com/HarshitBreaksProd" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors cursor-pointer">
                <FiGithub className="w-6 h-6 md:w-7 md:h-7"/>
              </a>
            </div>
            <div className="hover:scale-110 transition-all duration-300">
              <a href="https://github.com/HarshitBreaksProd/meetdraw" target="_blank" rel="noopener noreferrer" className="text-neutral-400 hover:text-white transition-colors cursor-pointer">
